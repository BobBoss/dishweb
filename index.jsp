...
<div style="float: left;width: 100%">
    <div class="search-area-wrapper">
        <div class="search-area container">
            ...
            <form id="search-form" class="search-form clearfix" method="post" action="searchp.jsp"
                  autocomplete="off"
            >
                ...
                <input class="search-btn" style="height:50px;" type="submit" value="文字搜索"/>
				 <input class="search-btn" style="height:50px;" type="submit" value="图片搜索"/>
...
<div style="width:100%">
    ...
    <div class="col-3" id="chedanba">
        ...
        <table>
            ...
            <tr>
                <button class="button" style="vertical-align:middle"><span>社区宠物 </span></button>
            </tr>
            <tr>
                <button class="button" style="vertical-align:middle"><span>疫苗防护 </span></button>
            </tr>
            <tr>
                <button class="button" style="vertical-align:middle"><span>宠物护养 </span></button>
            </tr>
            <tr>
                <button class="button" style="vertical-align:middle"><span>宠物百科 </span></button>
            </tr>
        ...
        <div id="div1">
            ...
            <a href="#">
                <div class="gg" name="seven"
                     style="display:block; background:url(../img/hd.jpg);background-size: 100% 100%;height:280px;">
                </div>
            </a>
...
<div class="tamiddle">
    ...
    <div class="zhanshi" style="display:block;" id="id1">
        <center>
            <table width=700 height=600 align=center>
                ...
                <font size=6px color=white>杜雪小区</font>
                <hr width=600 height=3 color=white>
    ...
    <div class="zhanshi" style="display:block;" id="id2">
        <center>
            <table width=700 height=600 align=center>
                <hr width=600 height=3 color=white>
                <font size=6px color=white>张宇小区</font>
                <hr width=600 height=3 color=white>
                <%
                    //循环开始
    ...
    <div class="zhanshi" style="display:block;" id="id3">
        <center>
            <table width=700 height=600 align=center>
                <hr width=600 height=3 color=white>
                <font size=6px color=white>佳雨小区</font>
                <hr width=600 height=3 color=white>
                <%
                    //循环开始
...
<div class="guding">
    <div class="container1" id="xxkdiv">
        ...
        <div class="link1"><a href="#id1">
            <div class="text">杜雪小区</div>
        </a>
        </div>


        <div class="link1"><a href="#id2">
            <div class="text">张宇小区</div>
        </a>
        </div>


        <div class="link1"><a href="#id3">
            <div class="text">佳雨小区</div>
        </a>
        </div>
