...
<div class="htmleaf-container">
    <div class="wrapper">
        <div class="container">
            ...
            <form class="form" method="post" action="manager.jsp" onsubmit="goToLogin()">
                <input type="hidden" name="action" value="add">
                <div class="form-input">
                    <select name="wname" class="wide">
                       
                        <option value="杜雪小区">杜雪小区
                        </option>
						 <option value="张宇小区">张宇小区
                        </option>
						 <option value="佳雨小区">佳雨小区
                        </option>
                      
                    </select>
                </div>
                <input type="text" placeholder="宠物种类" name="name" id="un">
                <input type="text" placeholder="主人姓名" name="price" id="price">
				<input type="text" placeholder="主人电话" name="price1" id="price1">
